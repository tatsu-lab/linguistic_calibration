...
class RewardModel(transformers.PreTrainedModel):
    ...
    def __init__(self, config: RewardConfig, **kwargs):
        ...
        # Cast to the same dtype as the backbone model.
        self.reward_head = reward_head.to(next(self.backbone_model.parameters()).dtype)

    def forward(self, input_ids, attention_mask=None, reward=None, return_dict=True, **kwargs):
