...
def requires_chatml(model: str) -> bool:
    ...
    return "turbo" in model or "gpt-4" in model or "claude-3-opus-20240229" in model or any(
        llama_chat_model_name in model for llama_chat_model_name in constants.LLAMA_2_CHAT_MODELS)
